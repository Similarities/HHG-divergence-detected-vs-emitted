...
class Open_and_Plot_Picture:
        def __init__(self, filename,  xlabel, ylabel,xmin, xmax, z):
            ...
            self.filedescription= "20190123_"+"_"+self.filename[-6:-4] +"  z " + str(self.z) 
        ...
        def plot_HHG_800nm (self):
            ...
            plt.savefig("20190122_" + str(self.z) + ".png",  bbox_inches="tight", dpi = 1000)
...
Picture1=Open_and_Plot_Picture('spectro1__Tue Jan 22 2019_17.51.45_71.tif', 'nm', 'counts', 550, 650, '2200um GVD 900')
Picture1.open_file()
...
Picture1=Open_and_Plot_Picture('spectro1__Tue Jan 22 2019_17.48.41_69.tif', 'nm', 'counts', 1100, 1200, '2200um GVD 600')
Picture1.open_file()
#Picture2.integrate_and_plot()
Picture1.background()
Picture1.grating_function()
...
Picture1=Open_and_Plot_Picture('spectro1__Tue Jan 22 2019_17.57.15_74.tif', 'nm', 'counts', 700, 800, '2200um GVD 0')
Picture1.open_file()
#Picture2.integrate_and_plot()
Picture1.background()
Picture1.grating_function()
